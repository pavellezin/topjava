...
public abstract class JdbcMealRepository<T> implements MealRepository {
    ...
    abstract T dateTimeDbConverter(LocalDateTime ldt);
    ...
    public static class LocalDateTimeMealRepository extends JdbcMealRepository<LocalDateTime>{
        ...
        @Override
        LocalDateTime dateTimeDbConverter(LocalDateTime ldt) {
            return ldt;
        }
    }
    @Repository
    ...
    public static class TimeStampMealRepository extends JdbcMealRepository<Timestamp>{
        ...
        @Override
        Timestamp dateTimeDbConverter(LocalDateTime ldt) {
    ...
    public Meal save(Meal meal, int userId) {
        MapSqlParameterSource map = new MapSqlParameterSource()
                ...
                .addValue("date_time", dateTimeDbConverter(meal.getDateTime()))
    ...
    public List<Meal> getBetweenHalfOpen(LocalDateTime startDateTime, LocalDateTime endDateTime, int userId) {
        return jdbcTemplate.query(
                ...
                ROW_MAPPER, userId, dateTimeDbConverter(startDateTime), dateTimeDbConverter(endDateTime));
    }
}
